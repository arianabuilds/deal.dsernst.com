  ...
  return (
    <SlideWrapper className="justify-center gap-4">
      ...
      <h2 className="font-serif text-4xl leading-tight md:text-5xl">
        Easy, Safe, & Smart
        <br />
        <span className="text-indigo-400">Digital Voting</span>
      </h2>
      ...
      <div className="flex flex-col items-end gap-4">
        ...
        <span className="w-fit rounded-full border border-lime-400/60 px-4 py-1.5 font-mono text-xs uppercase tracking-widest text-indigo-400">
          SIV.org • Feb 2026
        </span>
      </div>
    </SlideWrapper>
